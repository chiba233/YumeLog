<template>
  ...
  <div class="contacts">
    ...
    >
      ...
      <span :lang="lang" class="contactsBotton commonText">
        {{ getLabel(item) }}
      </span>
    </n-button>
  </div>
...
import { globalColorDeep, themeColor } from "@/shared/lib/app/useTheme.ts";
import { getMaiUrl } from "@/shared/lib/external/maimaiScore.ts";
import { maiSections } from "@/shared/lib/app/setupJson.ts";
